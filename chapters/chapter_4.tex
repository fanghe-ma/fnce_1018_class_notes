...
\begin{remark}
    ...
    $T \downarrow$ & Taxes on households & $\downarrow$ followed by  $\shortuparrow$ a little & $\downarrow$ \\
    $\tau \downarrow$ & Business (corporate) tax rate & $\shortuparrow$ a little & $\shortuparrow$ a little \\
    \end{tabular}
    \end{center}
\end{remark}
